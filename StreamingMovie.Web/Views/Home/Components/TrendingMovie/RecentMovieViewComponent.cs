...
namespace StreamingMovie.Web.Views.Home.Components.RecentMovie
{
    public class TrendingMovieViewComponent : ViewComponent
    {
        private readonly IUnifiedMovieService _unifiedMovieService;
        private readonly IMemoryCache _cache;
        private readonly IMapper _mapper;

        public TrendingMovieViewComponent(
        ...
        {
            const string cacheKey = "TrendingMovie_Cached";
